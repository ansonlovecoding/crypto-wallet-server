...
func TestGetBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "happy path",
			args: args{addr: "0x36587c80f8652875bcb4bb85de44409ef9a35245"},
			want: want{50000000000000000, false},
		},
		{
			name: "happy path",
			args: args{addr: "0x24b11b06de55b09cb1c2d667af4abf570ac29088"},
			want: want{50000000000000000, false},
		},
		{
			name: "happy path",
			args: args{addr: "0x048caa04b0976aa80f8a18616d0f6c13b27d4e5b"},
			want: want{50000000000000000, false},
		},
	}
...
func TestGetBlockByNumber(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			blockInfo, err := et.GetBlockByNumber(big.NewInt(int64(tt.args.txNum)))
			if (err == nil) == tt.want.isErr {
